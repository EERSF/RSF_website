        ...
        <div className="container ">
          <div className="row">
            <div className="col-md-4">
              ...
              <div className="py-1"> <a className="text-decoration-none text-white" href="https://instagram.com/eersf_iitropar?utm_source=qr&igshid=MThlNWY1MzQwNA==">Instagram</a></div>
